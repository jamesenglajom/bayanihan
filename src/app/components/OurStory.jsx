    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-12 lg:gap-20">
        ...
        >
          <motion.div
            variants={textVariants}
            className="font-bold text-blue-600 dark:text-blue-400 tracking-widest uppercase text-sm"
          >
            Heritage
          </motion.div>
          ...
          <motion.h2
            variants={textVariants}
            className="font-bold text-4xl md:text-5xl lg:text-6xl font-fraunces leading-[1.1] text-neutral-900 dark:text-neutral-100"
          >
          ...
          <motion.div
            variants={textVariants}
            className="text-neutral-600 dark:text-neutral-400 text-base md:text-lg leading-relaxed space-y-6"
          >
            <p>
              Bayanihan Exchange in Sweden (BES) is a community‑driven,
              non‑profit cultural organisation dedicated to celebrating the
              richness of Filipino heritage, showcasing Filipino talents, and
              fostering meaningful cultural exchange across Sweden. Open to all,
              BES brings people together through the Filipino spirit of{" "}
              <span className="text-blue-600 dark:text-blue-400 font-semibold italic">
                bayanihan
              </span>
              —lifting one another through shared effort, shared joy, and shared
              purpose.
            </p>
            ...
            <p className="hidden md:block">
              ...
              freely, where perspectives meet, and where a deep sense of
              community and belonging naturally takes root. It is a space where
              people can celebrate who they are, learn from one another, and
              build bridges between Filipino heritage and Swedish society.
            </p>

            <p className="hidden lg:block text-sm opacity-90 border-l-2 border-blue-600/30 pl-4 italic">
              ...
              valued, every story has a place, and every individual feels part
              of a shared and thriving community.
            </p>
          </motion.div>
          ...
          >
            ...
            <li className="flex items-center gap-4 text-neutral-800 dark:text-neutral-200 group">
              ...
              <span className="font-medium">
                Commitment to a shared thriving future
              </span>
            </li>
          </motion.ul>
        </motion.div>
